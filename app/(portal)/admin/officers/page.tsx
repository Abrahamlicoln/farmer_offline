    ...
    <div className="flex-1 flex flex-col min-w-0 font-sans">
      ...
      {selectedOfficerForFarmers && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-150">
          <div className="bg-white rounded-lg border border-gray-200 shadow-xl max-w-4xl w-full max-h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-150">
            {/* Modal Header */}
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-slate-50/80">
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  <h3 className="text-base font-bold text-[#0E121B]">
                    Farmers Registered by {selectedOfficerForFarmers.fullName}
                  </h3>
                ...
                <p className="text-xs text-slate-500">
                  {selectedOfficerForFarmers.email} &bull;{" "}
                  {selectedOfficerForFarmers.role === "admin"
                    ? "Operations Admin"
                    : "Field Officer"}
                </p>
              </div>
              ...
              <button
                ...
                className="w-8 h-8 rounded-md flex items-center justify-center text-slate-400 hover:text-slate-700 hover:bg-slate-200/60 cursor-pointer"
                title="Close"
              >
                ✕
              </button>
